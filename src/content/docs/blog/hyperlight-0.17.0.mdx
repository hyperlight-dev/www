...
We do plan to eventually optimize performance for Apple M3 and later, which
should be able to achieve performance similar to our other supported platforms.
But as a starting point we figured we should prioritize compatibility
